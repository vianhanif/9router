...
export async function getPricing() {
  ...
  const { PROVIDER_PRICING } = await import("@9router/core/providers/pricing.js");
  const merged = {};
...
export async function getPricingForModel(provider, model) {
  ...
  const { getPricingForModel: resolveConst } = await import("@9router/core/providers/pricing.js");
