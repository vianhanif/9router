  ...
  return dedupRefresh("xai", refreshToken, async () => {
    try {
      if (!_xaiServiceSingleton) {
        const mod = await import(/* webpackIgnore: true */ "../../../../../src/lib/oauth/services/xai.js");
...
async function resolveKiroProfileArnPatch(providerSpecificData, accessToken, refreshedArn) {
  ...
  if (!profileArn) {
    const { fetchKiroProfileArn } = await import(/* webpackIgnore: true */ "../../../../../src/lib/oauth/providers.js");
